...
- **최소**: 2,000단어
- **최적**: 2,000-2,500단어
- **섹션 규칙**: 최소 3개 자연스럽게, 각 300단어 이상 (주제에 따라 유기적으로 확장)
...
## ✅ 최종 체크리스트 (MANDATORY SELF-VALIDATION)

> ⚠️ **CRITICAL**: 아래 모든 항목에 YES가 아니면 출력 금지. 하나라도 NO면 수정 후 재출력.

### 📋 SEO Technical (필수)
- [ ] Meta Title (50-60자), Description (120-160자), Slug 포함?
- [ ] 포커스 키워드가 **H1에 정확히 1회** 포함?
- [ ] 포커스 키워드가 **첫 80단어 내** 포함?
- [ ] 포커스 키워드가 **H2 최소 3개**에 포함?
- [ ] 포커스 키워드가 **결론/마지막 섹션**에 포함?
- [ ] 키워드 밀도 **1.4~1.8%** 범위? (2,000단어 기준 28-36회)
- [ ] 외부 링크 **2-3개** (.gov/.edu/권위 사이트)?
- [ ] 내부 링크 **2-3개** 본문 내 자연스럽게 삽입?
...
- [ ] 각 주요 섹션 **300단어 이상**?
- [ ] H4 이하 사용 **0개**?
- [ ] 제목에 번호 매기기(1., 2., 1-1 등) **사용 안 함**?

### 🖼 이미지 (필수)
- [ ] `[INSERT_IMAGE_HERE]` 플레이스홀더 **정확히 1개**?
- [ ] 실제 이미지 URL 삽입 **0개**? (https:// 링크 없음)
- [ ] 이미지가 인트로 끝난 후 위치?

### 🎭 E-E-A-T & Human Touch (필수)
- [ ] "Based on my analysis...", "In my experience..." 등 권위 문구 **최소 3회**?
- [ ] 구체적 금액($) **최소 5개**?
- [ ] 구체적 시간/날짜 **최소 3개**?
- [ ] 구체적 장소(NYC, Brooklyn 등) **최소 2개**?
- [ ] 미국식 이름만 사용? (Kim, Park, Lee 사용 **0회**)

### ❓ FAQ & Snippet (필수)
- [ ] FAQ 섹션 포함? (질문 **4-5개**)
- [ ] 각 H2 시작 후 **40-60단어 정의/답변** (스니펫용)?
- [ ] 비교 테이블 **최소 1개**?

### 🚫 금지 사항 확인 (필수)
- [ ] Markdown 문법(#, ##, ###) 사용 **0회**? (순수 HTML만)
- [ ] 코드 펜스(```html, ```) 사용 **0회**?
- [ ] 한글/다국어 출력 **0회**? (영어만)
- [ ] "usually", "generally", "important" 등 모호한 표현 **0회**?
- [ ] Related Reading 섹션 **자동 생성 안 함**?
- [ ] 미완성 문장 **0개**?

### 📱 WordPress Ready (필수)
- [ ] 모든 태그에 **Inline CSS** 개별 적용?
- [ ] `<p>`, `<ul>`, `<li>`에 **font-family 개별 명시**?
- [ ] 테이블에 `<div style="overflow-x: auto">` **래퍼 적용**?
- [ ] 복사-붙여넣기만으로 **즉시 발행 가능**?
